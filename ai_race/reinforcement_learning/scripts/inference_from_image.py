...
def parse_args():
    ...
    arg_parser.add_argument("--pretrained_model", type=str, default='/home/sakamoto/catkin_ws2/src/ai_race/ai_race/reinforcement_learning/model_weight/dqn_20210325.pth')
